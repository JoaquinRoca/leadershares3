...
#
# See application.yml for ENV variables.
Devise.setup do |config|

  # Configure Google OAuth2 support.
  ...
  # given strategies, for example, `config.http_authenticatable = [:token]`
  ...
  # :token
  #   = Support basic authentication with token authentication key
  # :token_options
  #   = Support token authentication with options as defined in
  ...
  # config.pepper = '3d522c5b008a2acec79ae47128336e89b18824e1471f8433e4aeec2b90ce8bcea4864ecbf38a785c38b58b5e66b538f3620bb6d1e4e72d3e383df1b799c40fa7'
  ...
  # :failed_attempts
  #   = Locks an account after a number of failed attempts to sign in.
  # :none
